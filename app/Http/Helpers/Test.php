        ...
        if($tests && $tests['hits']['total']['value']){
            foreach($tests['hits']['hits'] as $test){
                ...
                $response['tests'][] = [
                    ...
                    'travel'            => $test['_source']['travel'],
                    'fever'             => $test['_source']['fever'],
                    'cough'             => $test['_source']['cough'],
                    'throatPain'        => $test['_source']['throatPain'],
                    'headache'          => $test['_source']['headache'],
                    'symptomWeek'       => $test['_source']['symptomWeek'],
                    'conditions'        => $test['_source']['conditions'],
                    'sick'              => $test['_source']['sick'],
